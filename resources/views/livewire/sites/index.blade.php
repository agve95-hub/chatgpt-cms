<div class="space-y-8">
    ...
    <section class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-zinc-200">
        ...
        <form method="POST" action="/sites" class="mt-4 grid gap-4 md:grid-cols-3">
            @csrf
            <input name="name" type="text" placeholder="Project name" class="rounded-lg border border-zinc-300 px-3 py-2" />
            <input name="repo_url" type="url" placeholder="https://github.com/owner/repo" class="rounded-lg border border-zinc-300 px-3 py-2" />
            <input name="repo_branch" type="text" placeholder="main" class="rounded-lg border border-zinc-300 px-3 py-2" />
                ...
                <tbody class="divide-y divide-zinc-100 bg-white">
                    @forelse ($sites as $site)
                        <tr>
                            ...
                            <td class="px-6 py-4 text-zinc-700">{{ $site->status }}</td>
